...
class PSPNet101(Network):
    def setup(self, is_training, num_classes, crop_size=None):
        '''Network definition.
        ...
        if not crop_size:
              crop_size[0] = 713
              crop_size[1] = 713
        h = int((crop_size[0] - 1.0) / 8.0 + 1.0)
        w = int((crop_size[1] - 1.0) / 8.0 + 1.0)
        h_pool2 = int(math.ceil(h/2))
        w_pool2 = int(math.ceil(w/2))
        h_pool3 = int(math.ceil(h/3))
        w_pool3 = int(math.ceil(w/3))
        h_pool6 = int(math.ceil(h/6))
        w_pool6 = int(math.ceil(w/6))
        ...
        (self.feed('conv5_3/relu')
             .avg_pool(h_pool2, w_pool2, h_pool2, w_pool2, name='conv5_3_pool2')
        ...
        (self.feed('conv5_3/relu')
             .avg_pool(h_pool3, w_pool3, h_pool3, w_pool3, name='conv5_3_pool3')
        ...
        (self.feed('conv5_3/relu')
             .avg_pool(h_pool6, w_pool6, h_pool6, w_pool6, name='conv5_3_pool6')
